---
{"publish":true,"title":"\bDeep & Cross Network","created":"2024-10-30","tags":["recsys"],"cssclasses":""}
---
...
- **layer의 개수**는 피쳐들 간의 high-order interaction을 **몇 차**까지 모델링할 건지를 의미함
	...
	- ...
- 각 layer에서 이번 layer의 입력($x'$)과 처음 입력값($x_0$)을 cross 
...
- Mixture of low-rank experts
	...
	- weighted sum을 어떻게 할 건지는 gating network가 입력 $x_l$을 보고 결정
