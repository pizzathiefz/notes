...
$$L\_{MMD} = \left| \frac{1}{|\mathcal{D}_w|} \sum_{\mathcal{D}\_w} \hat{\mathbf{y}} - \frac{1}{|\mathcal{D}_c|} \sum_{\mathcal{D}\_c} \hat{\mathbf{y}} \right|^2$$
...
$$L\_{final} = L\_{BCE}(\hat{\mathbf{y}}, \mathbf{y}) + \lambda\_1 L\_{BCE}(\hat{\mathbf{y}}_{mix}, \mathbf{y}_{mix}) + \lambda\_2 L\_{MMD}(\hat{\mathbf{y}}, \mathbf{y})$$

- $\lambda\_1 = 0.2$, $\lambda\_2 = 0.1$ (경험적 튜닝)
- 학습 데이터: 27일, 1 epoch
