---
{"publish":true,"title":"Multi-Embedding Retrieval Framework for Homfeed (Pinterest)","created":"2025-07-28","tags":["recsys"],"cssclasses":""}
---
...
![[assets/multi-embedding retrieval framework for homfeed (pinterest)/failed-case.png|600]]
- 기존 모델의 failed case
...
![[assets/multi-embedding retrieval framework for homfeed (pinterest)/multi-embedding-retrieval-framework.png|500]]
...
![[assets/multi-embedding retrieval framework for homfeed (pinterest)/implicit-user-interest-modeling.png|525]]


# Explicit User Interest Modeling

![[assets/multi-embedding retrieval framework for homfeed (pinterest)/explicit-user-interest-modeling.png|550]]
...
![[assets/multi-embedding retrieval framework for homfeed (pinterest)/results.png|625]]
