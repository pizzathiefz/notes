---
publish: true
title: 스파크 스트리밍 쿼리 101
created: 2025-08-11
modified: 2025-08-12T23:40:57.000+09:00
published: 2025-08-12T23:40:57.000+09:00
tags:
  - spark
---
...
- 🚨**스트리밍에서는 안 되는 쿼리 (operations)** 🚨
  - 밥먹듯이 쓰던 게 스트리밍에서는 안되는 경우가 많았다 예를 들면,
    ...
    - **event time or processing time 컬럼을 기반으로 하는 time-based window가 아닌 다른 Window 연산** - 즉 일반적으로 많이 사용하는 row\_number, rank, lead/lag 등등
    - pivot
